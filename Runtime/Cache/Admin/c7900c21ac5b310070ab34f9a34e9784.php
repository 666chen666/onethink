...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">内容<span class="check-tips">(详细叙述报修问题)</span></label>
			<div class="controls textarea input-large">
				<textarea class="text " name="content"><?php echo ((isset($info["content"]) && ($info["content"] !== ""))?($info["content"]):''); ?></textarea>
			</div>
		</div>
		<div class="form-item">
